...
const serverUrl =
    process.env.NODE_ENV === "production"
        ? "https://telestrations.onrender.com"
        : "http://localhost:3001"
...
const Room = ({ params }: ParamsProps) => {
    ...
    return (
        ...
        >
            ...
            <h1 className="block w-max p-3 mx-auto text-2xl font-semibold text-center text-amber-400 transition-all rounded-md bg-blue-800 md:text-3xl btn-shadow">
                Game Room: {roomId}
            </h1>
